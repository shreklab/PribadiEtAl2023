...
# Figure 3B-C: Analysis of egg distributions in streaked plates or predator exposure
...
d$Condition = factor(
  d$Condition, 
  levels=c("control","smeared","predator"
  )
)
