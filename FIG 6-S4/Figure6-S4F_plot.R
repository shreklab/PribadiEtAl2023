...
# Figure6-S4C_plot: Generate plot for Fig 6-S4F  WormWatcher data with bootstrap intervals & sig asterisks.
...
polygon(c(t,rev(t)),c(lo2,rev(hi2)),col = adjustcolor("#b7687a",alpha.f = 0.5),border=NA)
