...
# Figure 6I_plot: Generate effects contrast plot for changes to the Predator vs. Control off-lawn laying response delta.
...
ph = ph[c("predator_wt - control_wt",
          ...
          "predator_APDErescue - control_APDErescue",
          "predator_CEPrescue - control_CEPrescue"),]
