...
# Figure 6G-I_analysis: Analysis of eggs with predator exposure & CEP/ADE/PDE rescue
...
d$Genotype = factor(d$Genotype,
                      levels=c("wt","cat2(e1112)","APDErescue","CEPrescue"))
######### DATA PROCESSING ######### 
