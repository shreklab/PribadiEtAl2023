...
# Figure 6B_plot: Generate effects contrast plot for changes to the baseline off-lawn laying probability.
...
ph = ph[[mdl]]
ph = ph[c("control_cat1 - control_wt",
"control_cat2 - control_wt",
"control_tph1 - control_wt",
"control_tbh1 - control_wt",
"control_tdc1 - control_wt"),]
