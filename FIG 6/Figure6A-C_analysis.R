...
# Figure 6A-C_analysis: Analysis of eggs with predator exposure & bioamine gene mutants.
...
d$Genotype = factor(d$Genotype,
                      levels=c("wt","cat1","cat2","tph1","tbh1","tdc1"))
######### DATA PROCESSING ######### 
