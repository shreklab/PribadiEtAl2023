...
# Figure 6C_plot: Generate effects contrast plot for changes to the Predator vs. Control off-lawn laying response delta.
...
ph = ph[c("predator_wt - control_wt",
          "predator_cat1 - control_cat1",
          "predator_cat2 - control_cat2",
          "predator_tph1 - control_tph1",
          "predator_tbh1 - control_tbh1",
          "predator_tdc1 - control_tdc1"),]
