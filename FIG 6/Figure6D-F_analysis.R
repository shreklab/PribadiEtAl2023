...
# Figure 6D-F_analysis: Analysis of eggs with predator exposure & cat-2 alleles
...
d$Genotype = factor(d$Genotype,
                      levels=c("wt","cat2(n4547)","cat2(e1112)"))
######### DATA PROCESSING ######### 
...
mdls = list(
  ...
  #pOff = glmer(cbind(off,on) ~ Condition*Genotype + (1|Arena),dd,family=binomial),
