...
# Figure 6E_plot: Generate effects contrast plot for changes to the baseline with cat-2 alleles
...
ph = ph[[mdl]]
ph = ph[c("control_cat2(n4547) - control_wt",
          "control_cat2(e1112) - control_wt"),]
...
if(plotscale == "linear"){
  ...
  xlims=bestupperlim(c(-2,4)*limitsOverage+range(deltas),mod=5,digits=1)
