...
# Figure 6H_plot: Generate effects contrast plot for changes to the baseline with & CEP/ADE/PDE rescue
...
ph = ph[[mdl]]
ph = ph[c("control_cat2(e1112) - control_wt",
          "control_APDErescue - control_wt",
          "control_CEPrescue - control_wt"),]
