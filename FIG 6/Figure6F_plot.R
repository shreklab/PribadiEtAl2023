...
# Figure 6F_plot: Generate effects contrast plot for changes to the Predator vs. Control off-lawn laying response delta.

rm(list=ls())  # for console work
graphics.off() # for console work

wd="~/../Dropbox/chalasanilabsync/mrieger/Manuscripts/PribadiEtAl-2022/FINALv2/Figures/FIG 6/"
prefix = "Figure6D-F"
mdl = "pOff"
plotscale = "log2"
plotjitter=0.08
...
"predator_cat2(n4547) - control_cat2(n4547)",
"predator_cat2(e1112) - control_cat2(e1112)"
),]
...
if(plotscale == "linear"){
  ...
  xlims=bestupperlim(c(-4,1)*limitsOverage+range(deltas),mod=5,digits=1)
