...
# Figure 8C_plot: Generate effects contrast plot for changes to the baseline off-lawn laying probability.
...
ph = ph[c("control_dop1234 - control_wt",
"control_dop1 - control_wt",
"control_dop2 - control_wt",
"control_dop3 - control_wt",
"control_dop4 - control_wt"),]
...
ylabs=c(levels(dd$Genotype)[2],levels(dd$Genotype)[c(-1,-2)])
