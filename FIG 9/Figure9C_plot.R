...
# Figure 9C_plot: Generate effects contrast plot for changes to the Predator vs. Control off-lawn laying response delta.
...
ph2 = ph[-1,] # remove wt.
ph = rbind(ph[1,],
           ph2[order(ph2$estimate,decreasing = TRUE),])
...
ylabs=c(levels(dd$Genotype)[1],levels(dd$Genotype)[-1][order(ph2$estimate,decreasing = TRUE)])
