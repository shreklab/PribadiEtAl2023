...
# Figure 9E_plot: Generate effects contrast plot for changes to the baseline off-lawn laying probability.
...
ph = ph[[mdl]]
ph = ph[c("control_d123 - control_wt",
"control_d1234 - control_wt"),]
