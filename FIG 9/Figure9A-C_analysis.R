...
# Figure 8B-D_analysis: Analysis of eggs with predator exposure & dop receptor double mutants
...
d$Genotype = factor(d$Genotype,
                      levels=c("wt","d12","d13","d14","d23","d24","d34"))
######### DATA PROCESSING ######### 
