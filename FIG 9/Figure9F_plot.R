...
# Figure 9F_plot: Generate effects contrast plot for changes to the Predator vs. Control off-lawn laying response delta.
...
ph = ph[c("predator_wt - control_wt",
          "predator_d123 - control_d123",
          "predator_d1234 - control_d1234"),]
