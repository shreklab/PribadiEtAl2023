...
data.predator = dd[dd$Lawn == "streaky" & dd$Condition == "predator",] # raw data for the predator.
data.control = dd[dd$Lawn == "norm" & dd$Condition == "predator",] # raw data for the control.

exemplar.predator = exemplarData[exemplarData$Lawn == "streaky" & exemplarData$Condition == "predator",]
exemplar.control = exemplarData[exemplarData$Lawn == "norm" & exemplarData$Condition == "predator",]
