...
# Figure 4D_plot: Generate plot for Fig 4D Poff in no-predator, streaky vs. normal lawn.
...
data.predator = dd[dd$Lawn == "streaky" & dd$Condition == "control",] # raw data for the predator.
data.control = dd[dd$Lawn == "norm" & dd$Condition == "control",] # raw data for the control.

exemplar.predator = exemplarData[exemplarData$Lawn == "streaky" & exemplarData$Condition == "control",]
exemplar.control = exemplarData[exemplarData$Lawn == "norm" & exemplarData$Condition == "control",]
